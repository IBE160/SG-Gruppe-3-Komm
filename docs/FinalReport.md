...
**[Tobias]:**
Jeg meldte meg opp til dette emnet uten forkunnskaper i programmering, men med IT-kunnskaper som kanskje er litt over gjennomsnittet. AI er, og kommer til å bli, svært viktig i årene fremover. Den største aha-opplevelsen jeg har fått gjennom kurset, er å forstå hvor kraftig AI faktisk er. Jeg har brukt AI daglig både på jobb og fritid, men nå ser jeg at ChatGPT egentlig bare er toppen av isfjellet.

Det har vært interessant å bruke BMAD-metodikken og jobbe med KI-agenter. En tydelig utfordring har vært å formulere gode og presise prompt slik at AI faktisk gjør det man ønsker. Noen ganger måtte vi nesten tvinge AI-en i riktig retning. Jeg erfarte også at context-vinduet ikke bør bli for stort, fordi det fort kan gjøre at AI begynner å rote.

Det har også vært nyttig å lære om GitHub og hvordan det brukes i samarbeid og utvikling. Å committe og pushe endringer var nytt i starten, men gir mening nå. Ukentlige samlinger med skjermdeling har gjort læringsprosessen mer praktisk og forståelig, siden vi kunne jobbe gjennom stegene sammen.

Dette er et emne jeg gjerne skulle hatt mer tid til – ett semester føles litt kort når temaet er så relevant og stort.
