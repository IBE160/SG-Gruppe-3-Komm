...
**Utfordring 1: [BMAD / Gemini utfordringer]**
- Problem: [Vi følgte i faglærer sin spor så godt vi kunne, men hadde utfordringer med Gemini. Ofte forstod ikke gemini BMAD metodikken og rollen den skulle innta. Det tok til tider flere forsøk for å overbevise den eller for å tvingen den til å gjøre det vi viste den skulle gjøre.]
- Løsning: Det tok til tider flere forsøk for å overbevise den eller for å tvingen den til å gjøre det vi viste den skulle gjøre. Ved bra prompting som skildret hva Gemini faktisk skulle gjøre slik at den plukket opp trådene som den ellers slet med å
- KI sin rolle: [Hvordan hjalp eller hindret KI dere?]

**Utfordring 2: Oppdaterting i BMAD rammeverkt underveis i studiet. 
...
- Vi har måttet planlegge godt for å finne tider som har passet alle medlemene. 

### 3.3 KI-spesifikke utfordringer
[Problemer spesifikt knyttet til bruk av KI]
- Gemini klart ikke alltids å følge rammeverket i BMAD. 
- Med å overtale den med nøye skrevet prompts for å overbevise den om å gjøre det vi ville den skulle gjøre. Nøkkelord: Kontekstvindu
